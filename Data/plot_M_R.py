...
# step = 1000
file_name = 'eft_pnm32_000040_ldm_result.dat'
file_name1 = f'Result_1/{file_name}' # without metric
file_name2 = f'Result_2/{file_name}' # metric h, 1.0MeV/fm^3 ~ 100.0MeV/fm^3
file_name3 = f'Result_3/{file_name}' # metric h, 100.0MeV/fm^3 ~ 1000.0MeV/fm^3
