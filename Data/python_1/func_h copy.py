...
from interpolation import my_cubic_spline
...
for j in range(3, 101):
    ...
    p_i = 1.3234969191948892e-4 # 100.0 MeV/fm^3
    p_f = 1.3234969191948892e-3 # 1000.0 MeV/fm^3
    ...
    np.savetxt(f'../Result_3/eft_pnm32_{j:0>6}_ldm_result.dat', data, fmt='%.6E', delimiter=' ', 
                header='', comments='')
